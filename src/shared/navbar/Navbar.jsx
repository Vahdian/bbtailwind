  ...
  return (
    <div>
      ...
      <div
        className={
          menuChange
            ? "flex fixed w-full h-full bg-white z-50 flex flex-col text-2xl items-center p-16 text-center justify-center animation-fast font-bold  text-gray-600"
            : "hidden"
        }
      >
        <img
          src={voodgray}
          className="p-2 h-16 w-16 z-50"
          onClick={() => openMenu()}
          alt="vegan menu"
        ></img>
        <NavLink
